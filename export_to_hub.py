    ...
    def fn():
        for data_path in data_paths:
            yield {
                ...
                "colorized_image": {"path": data_path[1]},
            }
...
def main(args):
    ...
    new_data_paths = []
    for data_path in data_paths:
        original_image = os.path.join(data_path, "original_image.jpg")
        colorized_image = os.path.join(data_path, "colorized_image.jpg")
        new_data_paths.append((original_image, colorized_image))
